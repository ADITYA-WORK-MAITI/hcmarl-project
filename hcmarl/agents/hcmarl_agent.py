...
class HCMARLAgent:
    ...
    def __init__(self, obs_dim, global_obs_dim, n_actions, n_agents,
        ...
        self.ecbf_alpha1 = ecbf_params.get("alpha1", 0.05) if ecbf_params else 0.05
        self.ecbf_alpha2 = ecbf_params.get("alpha2", 0.05) if ecbf_params else 0.05
        self.ecbf_alpha3 = ecbf_params.get("alpha3", 0.1) if ecbf_params else 0.1
